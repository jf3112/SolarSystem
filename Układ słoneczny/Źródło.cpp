...
void Menu() {
	cout << "	STEROWANIE UKLADEM\n";
	cout << "		e - wlaczenie lub wylaczenie widoku orbit\n";
	cout << "		a - wlaczenie lub wylaczenie wiekszych planet\n";
	cout << "		s - przyspieszenie obrotow planet wokol Slonca\n";
	cout << "		w - spowolnienie obrotow planet wokol Slonca\n";
	cout << "		r - przyspieszenie obrotow planet wokol wlasnej osi\n";
	cout << "		f - spowolnienie obrotow planet wokol wlasnej osi\n\n";
	cout << "	STEROWANIE KAMERA\n";
	cout << "		LPM - poruszanie kamera\n";
	cout << "		PPM - zoom kamery\n";
	cout << "		k - przejscie w drugi tryb kamery\n";
	cout << "			domyslny tryb kamery - kamera na wybrana planete \n";
	cout << "			drugi tryb kamery - kamera z powierzchni wybranej planety\n";
	cout << "			(poczatkowo wybrane slonce)\n\n";
	cout << "	NUMERY PLANET\n";
	cout << "	aby wybrac dana planete nalezy nacisnac numer jej odpowiadajacy\n";
	cout << "		0 - Slonce\n";
	cout << "		1 - Merkury\n";
	cout << "		2 - Wenus\n";
	cout << "		3 - Ziemia\n";
